<?php 
    ...
    if( isset($_POST["regmhs"]) ) {
        if( userRegisterMahasiswa($_POST) > 0 ) {
            echo "<script>
    ...
    <div class="grid grid-cols-2 gap-5 h-screen">
        <div class="w-full px-40 py-12 flex flex-col gap-y-12">
            ...
            <div class="">
                ...
                <p class="text-3xl font-bold">Register Mahasiswa</p>
                <div class="">
                    <a href="./login_mhs.php" class="text-lg text-slate-500">Already have an account?</a>
                    <a href="./login_mhs.php" class="text-lg text-green-700 font-medium">Login</a>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="nrp" name="nrp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <select type="text" id="prodi" name="prodi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                ...
                <div class="mb-6">
                    <label for="jenjang" class="block mb-2 text-sm font-medium text-gray-900">Jenjang</label>
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input checked id="jenjang_d3" type="radio" value="D3" name="jenjang" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                        <label for="jenjang_d3" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">D3</label>
                    </div>
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input id="jenjang_d4" type="radio" value="D4" name="jenjang" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                        <label for="jenjang_d4" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">D4</label>
                    </div>
                </div>
                <div class="mb-6">
                ...
                <button type="submit" id="regmhs" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-full px-5 py-2.5 text-center" name="regmhs">Register</button>
            </form>
